...
type Endpoint3_13Request = Parameters<RawClient["server.session"]["session.contextUsage"]>[0]
...
const Endpoint3_13 = (raw: RawClient["server.session"]) => (input: Endpoint3_13Input) =>
  raw["session.contextUsage"]({ params: { sessionID: input["sessionID"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )
...
type Endpoint9_0Request = Parameters<RawClient["server.device"]["device.pair"]>[0]
type Endpoint9_0Input = { readonly name?: Endpoint9_0Request["payload"]["name"] }
const Endpoint9_0 = (raw: RawClient["server.device"]) => (input?: Endpoint9_0Input) =>
  raw["device.pair"]({ payload: { name: input?.["name"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

type Endpoint9_1Request = Parameters<RawClient["server.device"]["device.claim"]>[0]
type Endpoint9_1Input = { readonly code: Endpoint9_1Request["payload"]["code"] }
const Endpoint9_1 = (raw: RawClient["server.device"]) => (input: Endpoint9_1Input) =>
  raw["device.claim"]({ payload: { code: input["code"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

const Endpoint9_2 = (raw: RawClient["server.device"]) => () =>
  raw["device.list"]({}).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

type Endpoint9_3Request = Parameters<RawClient["server.device"]["device.revoke"]>[0]
type Endpoint9_3Input = { readonly deviceID: Endpoint9_3Request["params"]["deviceID"] }
const Endpoint9_3 = (raw: RawClient["server.device"]) => (input: Endpoint9_3Input) =>
  raw["device.revoke"]({ params: { deviceID: input["deviceID"] } }).pipe(Effect.mapError(mapClientError))

const adaptGroup9 = (raw: RawClient["server.device"]) => ({
  pair: Endpoint9_0(raw),
  claim: Endpoint9_1(raw),
  list: Endpoint9_2(raw),
  revoke: Endpoint9_3(raw),
})
...
type Endpoint10_7Request = Parameters<RawClient["server.permission"]["approval.request"]>[0]
type Endpoint10_7Input = {
  readonly sessionID?: Endpoint10_7Request["payload"]["sessionID"]
  readonly action: Endpoint10_7Request["payload"]["action"]
  readonly resources: Endpoint10_7Request["payload"]["resources"]
  readonly timeout_ms?: Endpoint10_7Request["payload"]["timeout_ms"]
}
const Endpoint10_7 = (raw: RawClient["server.permission"]) => (input: Endpoint10_7Input) =>
...
type Endpoint10_8Request = Parameters<RawClient["server.permission"]["approval.list"]>[0]
type Endpoint10_8Input = {
  readonly sessionID?: Endpoint10_8Request["query"]["sessionID"]
  readonly status?: Endpoint10_8Request["query"]["status"]
}
const Endpoint10_8 = (raw: RawClient["server.permission"]) => (input?: Endpoint10_8Input) =>
  raw["approval.list"]({ query: { sessionID: input?.["sessionID"], status: input?.["status"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

const Endpoint10_9 = (raw: RawClient["server.permission"]) => () =>
  raw["approval.jobs.list"]({}).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

type Endpoint10_10Request = Parameters<RawClient["server.permission"]["approval.get"]>[0]
type Endpoint10_10Input = { readonly requestID: Endpoint10_10Request["params"]["requestID"] }
const Endpoint10_10 = (raw: RawClient["server.permission"]) => (input: Endpoint10_10Input) =>
  raw["approval.get"]({ params: { requestID: input["requestID"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

type Endpoint10_11Request = Parameters<RawClient["server.permission"]["approval.decide"]>[0]
type Endpoint10_11Input = {
  readonly requestID: Endpoint10_11Request["params"]["requestID"]
  readonly decision: Endpoint10_11Request["payload"]["decision"]
  readonly message?: Endpoint10_11Request["payload"]["message"]
  readonly actor?: Endpoint10_11Request["payload"]["actor"]
  readonly deviceID?: Endpoint10_11Request["payload"]["deviceID"]
}
const Endpoint10_11 = (raw: RawClient["server.permission"]) => (input: Endpoint10_11Input) =>
  raw["approval.decide"]({
...
const adaptGroup10 = (raw: RawClient["server.permission"]) => ({
  ...
  requestApproval: Endpoint10_7(raw),
  listApprovals: Endpoint10_8(raw),
  listApprovalJobs: Endpoint10_9(raw),
  getApproval: Endpoint10_10(raw),
  decideApproval: Endpoint10_11(raw),
})
...
type Endpoint19_0Request = Parameters<RawClient["server.asyncRun"]["asyncRun.create"]>[0]
type Endpoint19_0Input = {
  readonly tasks: Endpoint19_0Request["payload"]["tasks"]
  readonly review?: Endpoint19_0Request["payload"]["review"]
}
const Endpoint19_0 = (raw: RawClient["server.asyncRun"]) => (input: Endpoint19_0Input) =>
  raw["asyncRun.create"]({ payload: { tasks: input["tasks"], review: input["review"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

const Endpoint19_1 = (raw: RawClient["server.asyncRun"]) => () =>
  raw["asyncRun.list"]({}).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

type Endpoint19_2Request = Parameters<RawClient["server.asyncRun"]["asyncRun.get"]>[0]
type Endpoint19_2Input = { readonly runID: Endpoint19_2Request["params"]["runID"] }
const Endpoint19_2 = (raw: RawClient["server.asyncRun"]) => (input: Endpoint19_2Input) =>
  raw["asyncRun.get"]({ params: { runID: input["runID"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

type Endpoint19_3Request = Parameters<RawClient["server.asyncRun"]["asyncRun.replay"]>[0]
type Endpoint19_3Input = { readonly runID: Endpoint19_3Request["params"]["runID"] }
const Endpoint19_3 = (raw: RawClient["server.asyncRun"]) => (input: Endpoint19_3Input) =>
  raw["asyncRun.replay"]({ params: { runID: input["runID"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

const adaptGroup19 = (raw: RawClient["server.asyncRun"]) => ({
  create: Endpoint19_0(raw),
  list: Endpoint19_1(raw),
  get: Endpoint19_2(raw),
  replay: Endpoint19_3(raw),
})

type Endpoint20_0Request = Parameters<RawClient["server.schedules"]["schedules.create"]>[0]
type Endpoint20_0Input = {
  readonly sessionID?: Endpoint20_0Request["payload"]["sessionID"]
  readonly prompt: Endpoint20_0Request["payload"]["prompt"]
  readonly spec: Endpoint20_0Request["payload"]["spec"]
}
const Endpoint20_0 = (raw: RawClient["server.schedules"]) => (input: Endpoint20_0Input) =>
  raw["schedules.create"]({
    payload: { sessionID: input["sessionID"], prompt: input["prompt"], spec: input["spec"] },
  }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

const Endpoint20_1 = (raw: RawClient["server.schedules"]) => () =>
  raw["schedules.list"]({}).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

type Endpoint20_2Request = Parameters<RawClient["server.schedules"]["schedules.delete"]>[0]
type Endpoint20_2Input = { readonly scheduleID: Endpoint20_2Request["params"]["scheduleID"] }
const Endpoint20_2 = (raw: RawClient["server.schedules"]) => (input: Endpoint20_2Input) =>
  raw["schedules.delete"]({ params: { scheduleID: input["scheduleID"] } }).pipe(Effect.mapError(mapClientError))

const adaptGroup20 = (raw: RawClient["server.schedules"]) => ({
  create: Endpoint20_0(raw),
  list: Endpoint20_1(raw),
  delete: Endpoint20_2(raw),
})

type Endpoint21_0Request = Parameters<RawClient["server.spend"]["spend.session"]>[0]
type Endpoint21_0Input = { readonly id: Endpoint21_0Request["params"]["id"] }
const Endpoint21_0 = (raw: RawClient["server.spend"]) => (input: Endpoint21_0Input) =>
  raw["spend.session"]({ params: { id: input["id"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

const Endpoint21_1 = (raw: RawClient["server.spend"]) => () =>
  raw["spend.summary"]({}).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )

const adaptGroup21 = (raw: RawClient["server.spend"]) => ({ session: Endpoint21_0(raw), summary: Endpoint21_1(raw) })
...
const adaptClient = (raw: RawClient) => ({
  ...
  "server.device": adaptGroup9(raw["server.device"]),
  ...
  "server.asyncRun": adaptGroup19(raw["server.asyncRun"]),
  "server.schedules": adaptGroup20(raw["server.schedules"]),
  "server.spend": adaptGroup21(raw["server.spend"]),
})
